...
class WikiDataset(Dataset):
    ...
    def __init__(self, book_def, splitter, lang, seeds=[], match="", recursive=True,
    ...
    @classmethod
    def create_dataset_from_wiki(cls, lang, seeds=[], match="", recursive=True,
                                 limit=20, scanned_pickle="./vars/scanned.pkl",
                                 save_dataset_path="./vars/",
        ...
        ds_wiki = cls(book_def, splitter, lang, seeds, match, recursive, limit, scanned_pickle, save_dataset_path)
